...
document.querySelector("#createdBy").innerHTML += " Tomás Murphy";
...
function buildToDos(toDos) {
  ...
  /* var array = toDos.map(function(todo, index) {
...
//  3) Llamar a la función previamante creada 'buildToDos' pasándole como argumento el array toDoItems
...
//     línea para hacer el llamado a esta función (displayToDos)
//  6) Abrir y recargar la página
...
// Todos los elementos input tienen una propiedad llamada 'value' que nos permite acceder al texto que se encuentra
...
//  3) Setear el valor del input toDoInput como un string vacio ("") (Esto se realiza para que en la vista se borre lo que se
//  encontraba escrito)
...
// el tipo del evento, qué elemento fue el que lo llamó, los valores de dicho elemento, etc.
